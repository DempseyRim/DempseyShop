    ...
    <div id=imagenes>
        <div class="product" style="margin-left: 3em;">
            ...
            <div class="img-container">
                <img id="cajitaImagen" src="../IMG/Productos/medicinal.png"> <!-- IMAGEN GRANDE-->
            </div>
            <!--Inicio de imagenes bebes-->
            <div class="product-small-img">
                <img src="https://images-na.ssl-images-amazon.com/images/I/810KkKZwLXL._AC_SL1500_.jpg" onclick="mifuncion(this)"> <!-- imagenes pequenias-->
                <img src="../IMG/Productos/medicinal.png" onclick="mifuncion(this)"> <!-- imagenes pequenias-->
                <img src="https://images-na.ssl-images-amazon.com/images/I/91Ienzwg7%2BL._AC_SL1500_.jpg" onclick="mifuncion(this)"> <!-- imagenes pequenias-->
            </div>
        </div>
    </div>
<!-- JAVASCRIPT -->
...
<!-- Informacion de los productos -->
    ...
    <div id="informacion">
        <h2><font size=6><center>CAP Barbell Bola Medicinal. </h2></center></font><br>
        <p><font size=5> Descripción</p></font>
        <p><font size=3> 
            La bola medicinal de CAP Barbell es una herramienta clásica para fitness. 
            Utiliza esta pelota para desarrollar fuerza y coordinación. 
            Está diseñado con una sensación pegajosa para un agarre seguro y puede rebotar 
            para su uso con un compañero o pared.   
        </font><br><br>
            <font size=2><center>
            <br>Peso: 1.8 kg.
            <br>Color: Púrpura.
            <br>Marca: CAP Barbell.
            <br>Material: Caucho.
            <br><br>Precio: $730</p>
            </font></center><br><br>
            ...
            <?php  if (isset($_SESSION['nombre'])){  ?>
                <form action="transaccion.php" method="post" id="formulario">
                    <input type="hidden" value="CAP Barbell Bola Medicinal" name="prod">
                    <input type="hidden" value="730" name="prec">
